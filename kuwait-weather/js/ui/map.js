...
// Kuwait is about 200 km across, so it fits on one screen at zoom 8 — but the
// weather that reaches it does not, and the front is usually still over Iraq
// or the Gulf when it matters. Zooming out is the point of the lower bound.
const MIN_ZOOM = 4;
const MAX_ZOOM = 10;
const FRAME_MS = 500;
...
export function createMap(host, { lat, lon, zoom = 8, label = '' } = {}) {
