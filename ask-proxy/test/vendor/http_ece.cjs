// Vendored, unmodified, for dev-only conformance testing (see
// ../webpush.test.mjs) — never imported by app.js or worker.js at runtime.
// Source: https://github.com/martinthomson/encrypted-content-encoding
// (npm package "http_ece" v1.2.1, MIT License, © Martin Thomson & contributors)
'use strict';
/*
